...
현재 운영 프로젝트 `runningcall`은 `robom-labs/outbom`에 연결되어 있으며 공식 주소는 `https://outbom.robom.kr`입니다. 기존 `https://runningcall.vercel.app`도 호환 주소로 같은 배포를 제공합니다.
...
4. 1~2분 후 `https://outbom.robom.kr`에서 새 배포를 확인합니다.
